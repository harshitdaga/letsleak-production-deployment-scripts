...
this.__Pages = Pages = (function() {
  Pages.prototype.settings = {
    ...
    divWrapper: [true, Match.Optional(String), "pagesCont"],
    fields: [true, Object, {}],
    filters: [true, Object, {}],
  ...
  Pages.prototype.valuesEqual = function(v1, v2) {
    return EJSON.equals(v1, v2) || (_.isFunction(v1) && _.isFunction(v2) && v1.toString() === v2.toString());
  };
    ...
    if (this.router === "iron-router") {
      ...
      if (Meteor.isServer && this.fastRender) {
        ...
        FastRender.route(pr, function(params) {
          return this.subscribe(self.name, parseInt(params.page));
        });
